...
export const MAJOR_CITIES: Record<string, string[]> = {
  "United States": ["New York", "Los Angeles", "Chicago", "Houston", "Phoenix", "Philadelphia", "San Antonio", "San Diego", "Dallas", "San Jose", "Austin", "Seattle", "San Francisco", "Boston", "Denver"],
  "United Kingdom": ["London", "Birmingham", "Manchester", "Glasgow", "Liverpool", "Leeds", "Sheffield", "Edinburgh", "Bristol", "Manchester"],
  ...
  "Netherlands": ["Amsterdam", "Rotterdam", "The Hague", "Utrecht", "Eindhoven", "Tilburg", "Almere", "Groningen"],
  "Spain": ["Madrid", "Barcelona", "Valencia", "Seville", "Zaragoza", "Malaga", "Murcia", "Palma", "Las Palmas", "Bilbao"],
  "Italy": ["Rome", "Milan", "Naples", "Turin", "Palermo", "Genoa", "Bologna", "Florence", "Bari", "Catania"],
  "Brazil": ["Sao Paulo", "Rio de Janeiro", "Brasilia", "Salvador", "Fortaleza", "Belo Horizonte", "Manaus", "Curitiba", "Recife", "Goiania"],
};

export const INDUSTRY_POSITIONS: Record<string, string[]> = {
  "Technology": [
    "Software Engineer", "Senior Software Engineer", "Staff Engineer", "Principal Engineer",
    "Frontend Developer", "Backend Developer", "Full Stack Developer", "Mobile Developer",
    "DevOps Engineer", "Site Reliability Engineer", "Data Scientist", "Data Engineer",
    "Machine Learning Engineer", "AI Researcher", "Product Manager", "Technical Product Manager",
    "UX Designer", "UI Designer", "Product Designer", "Solutions Architect", "Cloud Architect",
    "Security Engineer", "Cybersecurity Analyst", "QA Engineer", "Engineering Manager",
    "Director of Engineering", "VP of Engineering", "CTO"
  ],
  "Finance": [
    "Investment Banker", "Financial Analyst", "Portfolio Manager", "Quantitative Analyst",
    "Risk Manager", "Compliance Officer", "Accountant", "Auditor", "Tax Consultant",
    "Wealth Manager", "Private Equity Associate", "Hedge Fund Analyst", "CFO",
    "Treasury Manager", "Actuary", "Credit Analyst", "Commercial Banker"
  ],
  "Healthcare": [
    "Physician", "Specialist Doctor", "Surgeon", "Nurse Practitioner", "Registered Nurse",
    "Pharmacist", "Medical Director", "Healthcare Administrator", "Biomedical Engineer",
    "Clinical Researcher", "Lab Technician", "Physical Therapist", "Occupational Therapist",
    "Psychiatrist", "Dentist"
  ],
  "Engineering": [
    "Mechanical Engineer", "Electrical Engineer", "Civil Engineer", "Chemical Engineer",
    "Aerospace Engineer", "Structural Engineer", "Industrial Engineer", "Environmental Engineer",
    "Project Engineer", "Systems Engineer", "Manufacturing Engineer", "Hardware Engineer"
  ],
  "Education": [
    "Professor", "Lecturer", "School Principal", "Educational Consultant", "Curriculum Developer",
    "Academic Researcher", "Special Education Teacher", "School Counselor", "Administrator"
  ],
  "Government": [
    "Policy Analyst", "Diplomat", "Foreign Service Officer", "Public Administrator",
    "Intelligence Analyst", "Urban Planner", "Legislative Assistant", "Program Manager"
  ],
  "Logistics": [
    "Supply Chain Manager", "Logistics Coordinator", "Operations Manager", "Warehouse Manager",
    "Procurement Specialist", "Inventory Analyst", "Fleet Manager", "Distribution Manager"
  ],
  "Marketing": [
    "Marketing Manager", "Brand Manager", "Digital Marketing Specialist", "Content Strategist",
    "SEO Specialist", "Social Media Manager", "Copywriter", "Art Director", "Market Researcher",
    "Public Relations Specialist", "Account Executive"
  ],
  "Manufacturing": [
    "Plant Manager", "Production Supervisor", "Quality Control Manager", "Process Engineer",
    "Supply Chain Analyst", "Safety Coordinator", "Operations Director"
  ],
  "Other": [
    "Consultant", "Legal Counsel", "Attorney", "HR Manager", "Recruiter", "Sales Executive",
    "Business Development Manager", "Customer Success Manager", "Executive Assistant"
  ]
};
